...
LIB_FLAGS := -Wl,--library-path=$(LIB_DIR),--library=$(),-rpath=$(LIB_DIR)
endif
else ifeq ($(CC), gcc)
...
LIB_FLAGS := -L$(LIB_DIR) -l$() -Wl,-rpath=$(LIB_DIR)
endif
else
